 ...
 */
public class GroupGoodsListAdapter extends BaseAdapter {
    BaseActivity mActivity;
    LayoutInflater inflater;
    private List list;

    public GroupGoodsListAdapter(BaseActivity mActivity, List list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_groupgood_list, null);
