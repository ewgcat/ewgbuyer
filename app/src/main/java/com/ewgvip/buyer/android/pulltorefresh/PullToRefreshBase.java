 ...
 *******************************************************************************/
package com.ewgvip.buyer.android.pulltorefresh;
...
import com.ewgvip.buyer.android.pulltorefresh.internal.FlipLoadingLayout;
import com.ewgvip.buyer.android.pulltorefresh.internal.LoadingLayout;
import com.ewgvip.buyer.android.pulltorefresh.internal.RotateLoadingLayout;
import com.ewgvip.buyer.android.pulltorefresh.internal.Utils;
import com.ewgvip.buyer.android.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		/**
		 * As we're currently in a ayout Pass, we need to schedule another one
	...
	public enum Mode {
		...
		/**
		 * @return true if this mode wants the Loading ayout Footer to be shown
		 */
