...
import com.ewgvip.buyer.android.zxing.decoding.CaptureActivity2Handler;
...
public class QRScan2Fragment extends Fragment
    ...
    private CaptureActivity2Handler handler;
    ...
    private void onResultHandler(String resultString, Bitmap bitmap) {
        if (TextUtils.isEmpty(resultString)) {
            ...
            if(resultString.contains("/spread/")){
                ...
                String scan_invitation_code=split[split.length-1];
                mActivity.setCache("scan_invitation_code",scan_invitation_code);
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            handler = new CaptureActivity2Handler(QRScan2Fragment.this, decodeFormats,
                    characterSet);
        }
    }
