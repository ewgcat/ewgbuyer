...
public class CommonUtil {
    ...
    public static String getAddress(Context context) {
        String address = context.getResources().getString(R.string.http_url);
        return address;
    }

    //功能：身份证的有效验证 @return 有效：返回"" 无效：返回String信息
    ...
    //Glide 自适应宽度加载图片。保持图片的长宽比例不变，通过修改imageView的高度来完全显示图片
    ...
    //Glide 自适应高度加载图片。保持图片的长宽比例不变，通过修改imageView的宽度来完全显示图片
    public static void loadIntoUseFitHight(Context context, final String imageUrl, int errorImageId, final ImageView imageView) {
        Glide.with(context)
                .load(imageUrl)
                .diskCacheStrategy(DiskCacheStrategy.SOURCE)
                .listener(new RequestListener<String, GlideDrawable>() {
    ...
    public static void installApkFromLocalPath(Activity activity, String apkname) {
        ...
        intent.setDataAndType(Uri.parse("file://" + Environment.getExternalStorageDirectory() + "/ewgvip/" + apkname), "application/vnd.android.package-archive");
