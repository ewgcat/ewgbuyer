...
import static com.ewgvip.buyer.android.R.drawable.indicator_bg_bottom;
import static com.ewgvip.buyer.android.R.drawable.indicator_bg_top;
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		switch (mode) {
			case PULL_FROM_END:
				...
				setBackgroundResource(indicator_bg_bottom);
			...
			case PULL_FROM_START:
				...
				setBackgroundResource(indicator_bg_top);
				break;
		}
