...
import static com.ewgvip.buyer.android.activity.BaseActivity.getDeviceID;

public class NormalPost3Request extends Request<Boolean> {
    private Map<String, String> mMap;
    private Listener<Boolean> mListener;
    private Context context;

    public NormalPost3Request(Context context, String url,
                              Listener<Boolean> listener, ErrorListener errorListener, Map map) {
    ...
    protected Response<Boolean> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            return Response.success(new Boolean(jsonString),
