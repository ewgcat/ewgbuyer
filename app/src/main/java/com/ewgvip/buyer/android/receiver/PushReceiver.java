...
public class PushReceiver extends PushMessageReceiver {
    ...
    /**
     * 调用PushManager.startWor]过程是异步的。绑定请求的结果通过onBind返回。 如果您需要用单播推送，需要把这里获取的channel
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            ...
            paraMap.put("app_id", channelId);
            paraMap.put("app_type", "Android");
            paraMap.put("app_role", "BUYER");
            ...
            Request<JSONObject> request = new NormalPostRequest(context,
                    context.getResources().getString(R.string.http_url)
                            + "/app/push_bind.htm",
    ...
    public void onNotificationClicked(Context context, String title,
        ...
        if (!TextUtils.isEmpty(customContentString)) {
            ...
            try {
                ...
                String value = customJson.getString("value");

                Bundle bundle = new Bundle();
                bundle.putString("action_type", type);
                bundle.putString("action_value", value);
